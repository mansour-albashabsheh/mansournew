...
gj.widget = function() {
        ...
        messages: {
            ...
            "ar-sa": {
                ...
                monthShortNames: ["يناير", "فبراير", "مارس", "أبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "اكتوبر", "نوفمبر", "ديسمبر"],
                weekDaysMin: ["ح", "ث", "ث", "ع", "خ", "ج", "س"],
                weekDaysShort: ["احد", "اثن", "ثلاث", "اربع", "خميس", "جمعة", "سبت"],
                weekDays: ["الاثنين", "الاثنين", "الخميس", "الاربعاء", "الخميس", "الجمعة", "السبت"],
                am: "ص",
                pm: "م",
                ok: "Ok",
                cancel: "Cancel",
